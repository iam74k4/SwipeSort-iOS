...
SwipeSort allows you to quickly sort photos and videos into "Keep", "Delete candidates", and "Favorites" using intuitive swipe gestures. Built with modern Swift 6 and SwiftUI for a beautiful, performant experience.
...
- **Swipe Up**: Add to favorites (syncs with iOS Favorites album ❤️)
- **Undo**: Revert the last action

### Review
- Segment picker: Delete candidates / Favorites
- Grid view with selection
- Batch delete or restore
- Manage favorites
- Deleted items go to iOS "Recently Deleted" (recoverable for 30 days)
...
│   │   │       └── SwipeOverlay.swift
│   │   ├── Review/
│   │   │   ├── ReviewFeature.swift       # Review screen
│   │   │   └── ReviewState.swift
│   │   └── Settings/
...
2. Swipe photos left/right/up to sort them
3. Go to "Review" tab to check deletion candidates or favorites
4. Delete or manage as needed
